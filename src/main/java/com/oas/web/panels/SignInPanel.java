...
import com.oas.web.pages.CustomerRegistrationPage;
...
public abstract class SignInPanel extends Panel {
	...
	public final class SignInForm extends Form {
		...
		public SignInForm(final String id) {
			...
			this.add(new IndicatingAjaxButton("login"){
			...
			this.add(new BookmarkablePageLink("customerRegistration", CustomerRegistrationPage.class));
